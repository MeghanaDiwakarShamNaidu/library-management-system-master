...
(1, 'meghana@gmail.com', '025db420560617303c2ba988d050ec62562343bc0fb0358d31d2f0bae8dbede8');
...
(1, 'Meghana', 'meghana@gmail.com', '025db420560617303c2ba988d050ec62562343bc0fb0358d31d2f0bae8dbede8', 'They watch you from the shelf while you sleep 👀. Are you dreaming of them, they wonder, in that wistful mood books are prone to at night when they’re bored and there’s nothing else to do but tease the cat.?', '', 0, '2021-11-09 00:00:00'),
(6, 'Sahana', 'sahana@gmail.com', '025db420560617303c2ba988d050ec62562343bc0fb0358d31d2f0bae8dbede8', 'Hi :)! Long time no see ❤️', '', 0, '2021-11-18 23:07:53');
...
-- change bio and other values to take null values
ALTER TABLE `users` MODIFY `bio` LONGTEXT COLLATE utf8mb4_unicode_520_ci NULL;
ALTER TABLE `users` MODIFY `mob` varchar(255) COLLATE utf8mb4_unicode_520_ci NULL;
ALTER TABLE `users` MODIFY `lock` TINYINT(1) NULL;
